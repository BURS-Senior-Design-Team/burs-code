 ...
 */
uint32_t UVAClass::readUVS(void) {
...
uint8_t UVAClass::writeRegister(uint8_t reg, uint8_t val){
...
uint8_t UVAClass::readRegister(uint8_t reg){
  uint8_t regValue = 0;
  _wire->beginTransmission(i2cAddress);
  _wire->write(reg);
